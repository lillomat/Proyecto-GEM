Codigos GEM
El archivo view.php se incorpora en la seccion de moodle/mod/emarking.
El archivo locallib.php,uploadpauta.php y processpauta.php se incorporan en la seccion moodle/mod/emarking/print.
El archivo uploadformpauta.php se incorpora en moodle/mod/emarking/forms
...
Al tener la prueba lista se procede a escanear la prueba en el tab Upload Answers, donde se inserta el zip RespuestasAlumnos.zip(esto no es escritamente necesario, si uno lo prefiere puede bajarse la aplicacion disponible en el tab Upload Answers y mediante emarkingdesktop crear el zip, para el curso y alumnos especificos).
Luego se pedira una rubrica para poder corregir la prueba, uno puede crear la rubrica que desea.
Finalmente solo falta corregir las pruebas de los alumnos inscritos.
Si lo desea el profesor puede subir la pauta mediante el tab Upload Pauta, esta debe ser obligatoriamente en formato PDF.
